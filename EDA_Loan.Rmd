...
base <- ggplot(aes(y = StatedMonthlyIncome, x = MonthlyLoanPayment), 
    ...
    theme_pander()
scatter1 <- base + geom_smooth(span = 0.3, method = 'lm', formula = y ~ splines::bs(x, 3))
scatter2 <- base + geom_smooth(span = 0.3, method = 'lm')
